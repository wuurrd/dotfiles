-- Glossy theme for Awesome 3.4
-- Copyright (C) 2011 Tuomas Jormola <tj@solitudo.net>
--
-- Licensed under the terms of GNU General Public License Version 2.0.
--
-- Designed to be used with Glossy GTK+ theme and GNOME icon theme.
-- Both are included in gnome-themes package of GNOME 2.3x.
...
-- Awesome icon
theme.awesome_icon                              = awful.util.getdir('config') .. '/themes/Glossy/awesome-icon.png'

-- Titlebar images
theme.titlebar_close_button_normal              = awful.util.getdir('config') .. '/themes/Glossy/titlebar/close_normal.png'
theme.titlebar_close_button_focus               = awful.util.getdir('config') .. '/themes/Glossy/titlebar/close_focus.png'

theme.titlebar_ontop_button_normal_inactive     = awful.util.getdir('config') .. '/themes/Glossy/titlebar/ontop_normal_inactive.png'
theme.titlebar_ontop_button_focus_inactive      = awful.util.getdir('config') .. '/themes/Glossy/titlebar/ontop_focus_inactive.png'
theme.titlebar_ontop_button_normal_active       = awful.util.getdir('config') .. '/themes/Glossy/titlebar/ontop_normal_active.png'
theme.titlebar_ontop_button_focus_active        = awful.util.getdir('config') .. '/themes/Glossy/titlebar/ontop_focus_active.png'

theme.titlebar_sticky_button_normal_inactive    = awful.util.getdir('config') .. '/themes/Glossy/titlebar/sticky_normal_inactive.png'
theme.titlebar_sticky_button_focus_inactive     = awful.util.getdir('config') .. '/themes/Glossy/titlebar/sticky_focus_inactive.png'
theme.titlebar_sticky_button_normal_active      = awful.util.getdir('config') .. '/themes/Glossy/titlebar/sticky_normal_active.png'
theme.titlebar_sticky_button_focus_active       = awful.util.getdir('config') .. '/themes/Glossy/titlebar/sticky_focus_active.png'

theme.titlebar_floating_button_normal_inactive  = awful.util.getdir('config') .. '/themes/Glossy/titlebar/floating_normal_inactive.png'
theme.titlebar_floating_button_focus_inactive   = awful.util.getdir('config') .. '/themes/Glossy/titlebar/floating_focus_inactive.png'
theme.titlebar_floating_button_normal_active    = awful.util.getdir('config') .. '/themes/Glossy/titlebar/floating_normal_active.png'
theme.titlebar_floating_button_focus_active     = awful.util.getdir('config') .. '/themes/Glossy/titlebar/floating_focus_active.png'

theme.titlebar_maximized_button_normal_inactive = awful.util.getdir('config') .. '/themes/Glossy/titlebar/maximized_normal_inactive.png'
theme.titlebar_maximized_button_focus_inactive  = awful.util.getdir('config') .. '/themes/Glossy/titlebar/maximized_focus_inactive.png'
theme.titlebar_maximized_button_normal_active   = awful.util.getdir('config') .. '/themes/Glossy/titlebar/maximized_normal_active.png'
theme.titlebar_maximized_button_focus_active    = awful.util.getdir('config') .. '/themes/Glossy/titlebar/maximized_focus_active.png'
