...
(defcustom twisted-dev-directory "/usr/lib/python2.6/dist-packages/twisted"
  "*Directory to base all twisted-dev utilities out of."
  :group 'twisted-dev
  :type 'string)


(defcustom twisted-dev-scratch-directory "/tmp"
...
Null prefix argument turns off the mode."
 ...
 '(
   ...
   ([(shift f9)] . twisted-dev-debug-tests)
   ([f5] . twisted-dev-grep)
))
