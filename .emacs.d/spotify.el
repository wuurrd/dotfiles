...
(if (eq system-type 'darwin)
    (progn
      (global-set-key (kbd "C-c <C-right>") (lambda () (interactive) (spotify-apple-player-next-track)))
      (global-set-key (kbd "C-c <C-left>") (lambda () (interactive) (spotify-apple-player-previous-track)))
      (global-set-key (kbd "C-c <up>") (lambda () (interactive) (spotify-apple-player-toggle-play)))
      )
    (progn 
